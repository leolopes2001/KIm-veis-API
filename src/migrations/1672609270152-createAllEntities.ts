...
export class createAllEntities1672609270152 implements MigrationInterface {
    name = 'createAllEntities1672609270152'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "district" character varying(20) NOT NULL, "zipCode" character varying(30) NOT NULL, "number" character varying, "city" character varying(30) NOT NULL, "state" character varying(30) NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
